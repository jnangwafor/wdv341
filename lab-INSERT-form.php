...
?>
        ...
        <?php
				...
				try{
					require 'connectingPDO.php';	//CONNECT to the database
					
					$todaysDate = date("Y-m-d");		//use today's date as the default
					
					//create insert commands to input data into the datsbase
					$sqlInsert = "INSERT INTO test(";
					$sqlInsert.= "prod_name,";
					$sqlInsert.= "prod_price,";
					$sqlInsert.= "prod_color,";
					$sqlInsert.= "prod_wagon,";
					$sqlInsert.= "prod_wagon_ordered";
					$sqlInsert.= ")VALUES (:prodName, :prodPrice, :prodColor, :prodWagon, :prodWagonOrdered)";
